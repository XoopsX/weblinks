# $Id: weblinks0.sql,v 1.1 2011/12/29 14:32:31 ohwada Exp $
...
#
# Table structure for table `weblinks0_category`
#

CREATE TABLE weblinks0_category (
...
#
# Table structure for table `weblinks0_link`
# add width, height
#

CREATE TABLE weblinks0_link (
...
#
# Table structure for table `weblinks0_modify`
# same as weblinks0_link
#

CREATE TABLE weblinks0_modify (
...
#
# Table structure for table `weblinks0_catlink`
#

CREATE TABLE weblinks0_catlink (
...
#
# Table structure for table `weblinks0_broken`
# same column as `mylinks_broken`
#

CREATE TABLE weblinks0_broken (
...
#
# Table structure for table `weblinks0_votedata`
# same as `mylinks_votedata`
#

CREATE TABLE weblinks0_votedata (
...
#
# Table structure for table `weblinks0_atomfeed`
#

CREATE TABLE weblinks0_atomfeed (
...
#
# Table structure for table `weblinks0_config`
#

CREATE TABLE weblinks0_config (
...
#
# Table structure for table `weblinks0_config2`
# modify from system `config`
#

CREATE TABLE weblinks0_config2 (
...
#
# Table structure for table `weblinks0_linkitem`
#

CREATE TABLE weblinks0_linkitem (
  id      smallint(5) unsigned NOT NULL auto_increment,
