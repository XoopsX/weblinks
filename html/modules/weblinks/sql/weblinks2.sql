...
#
# Table structure for table `weblinks2_category`
#

CREATE TABLE weblinks2_category (
...
# same as weblinks2_link
#

CREATE TABLE weblinks2_modify (
...
CREATE TABLE weblinks2_catlink (
...
CREATE TABLE weblinks2_votedata (
...
CREATE TABLE weblinks2_atomfeed (
...
CREATE TABLE weblinks2_config2 (
...
CREATE TABLE weblinks2_linkitem (
  id      smallint(5) unsigned NOT NULL auto_increment,
